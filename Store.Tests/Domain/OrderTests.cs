...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Thiago Cruz", "thagocruz@gmail.com");
        ...
        {
            var discont = new Discount(10, DateTime.Now.AddDays(-5));
            var order = new Order(_customer, 10, discont);
            order.AddItem(_product, 5);
